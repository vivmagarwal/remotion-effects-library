...
export const BarChartRace: React.FC<Props> = ({
  ...
  series = [
    ...
    {label: 'After Effects', color: '#f72585', values: [58, 62, 70, 76, 82, 88]},
    {label: 'Blender', color: '#ffd166', values: [30, 41, 55, 61, 70, 79]},
    {label: 'Figma', color: '#8ac926', values: [44, 48, 52, 57, 60, 64]},
    {label: 'Canva', color: '#a78bfa', values: [22, 30, 33, 38, 44, 47]},
  ],
  ...
  return (
    <AbsoluteFill name="Scene" style={{backgroundColor, padding: '80px 96px', fontFamily}}>
      <Interactive.Div
        name="Title"
        style={{fontSize: 52, fontWeight: 800, color: '#f4f5f8', letterSpacing: '-0.02em'}}
      >
        {title}
      </Interactive.Div>
      ...
      <div style={{height: 5, borderRadius: 3, backgroundColor: '#1b1d27', marginTop: 26}}>
        <div
          style={{
            height: '100%',
            borderRadius: 3,
