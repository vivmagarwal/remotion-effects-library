...
export const meta: EffectMeta = {
  id: 'sankey-flow', name: 'Sankey Flow', category: 'data',
  ...
  tags: ['data', 'chart', 'd3', 'sankey', 'flow', 'svg', 'gradient'],
  ...
  concepts: ['d3-sankey', 'mutating layout', 'sankeyLinkHorizontal', 'per-link gradients', 'conservation'],
};
