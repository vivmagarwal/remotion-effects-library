...
```tsx
effects={[
  duotone({darkColor: '#12123a', lightColor: '#ff4d6d', threshold: 0.34}),
...
**The page**
- 1920×1080, 30fps, 120 frames. Paper `#f6f1e4`.
...
- Bottom-left: a kicker at 30px with `letter-spacing: 0.42em`, and a headline in Archivo Black at
  196px, line-height 0.9, letter-spacing `-0.035em`, in the dark ink.
- **The headline gets `textShadow: '9px 7px 0 #ff4d6d'`** — a hard-edged offset copy in the second ink.
  That deliberate misregistration is the single most recognisable tell of a two-colour press, and it
  does more for the look than the halftone itself.
