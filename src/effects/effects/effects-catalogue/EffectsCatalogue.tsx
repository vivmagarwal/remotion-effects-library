...
export const EffectsCatalogue: React.FC<Props> = ({
  ...
  const tiles: Tile[] = [
    {name: 'duotone', call: "duotone({darkColor, lightColor})", effect: duotone({darkColor: '#131a3a', lightColor: '#ff8fa3', threshold: 0.4})},
        ...
        return (
          <Interactive.Div
            ...
            style={{
              ...
              overflow: 'hidden',
              backgroundColor: '#000',
              border: `2px solid ${lit ? accentColor : '#20242f'}`,
