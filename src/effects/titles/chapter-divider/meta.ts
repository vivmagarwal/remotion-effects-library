...
export const meta: EffectMeta = {
  id: 'chapter-divider', name: 'Chapter Divider', category: 'titles',
  ...
  tags: ['title', 'explainer', 'transition', 'editorial'],
  concepts: ['multi-keyframe interpolate', 'programmable in/out', 'single driver value'],
