...
export const PhotoStackShuffle: React.FC<Props> = ({
  ...
  return (
    <AbsoluteFill
      ...
      style={{
        backgroundColor,
        backgroundImage: 'radial-gradient(ellipse at 50% 44%, #232633 0%, #101116 66%)',
    ...
    >
      {cards.map((card, i) => {
        ...
        return (
          ...
          >
            <div style={{width: '100%', height: cardHeight, borderRadius: 4, overflow: 'hidden', backgroundColor: '#000'}}>
              <CanvasImage
