...
**The look**
- 1920×1080, 30fps, 300 frames. Base `#080711`, `overflow: hidden`.
- Five blobs: purple `#7c3aed`, blue `#2563eb`, pink `#db2777`, cyan `#0891b2` and a smaller amber
  `#f59e0b` in the middle. Each is an absolutely positioned circle sized 40–62% of the frame with
  `backgroundImage: radial-gradient(circle, COLOR 0%, COLOR00 70%)`.
...
- Props: `blobs` (array of `{color, x, y, size, travel, speed, phase}`), `backgroundColor`, `blur`,
  `grain` — optional, with the defaults above.
