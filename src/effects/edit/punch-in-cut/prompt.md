...
- A readout pill top-left at `left: 84, top: 84`: `1.05×` at 54px/800, then `CUT 2` at 28px/700 with
  ...
  `padding: 14px 26px`, `borderRadius: 12`, `rgba(10,11,16,0.72)`,
...
- A 6px cut strip along the bottom at `left/right: 84, bottom: 84`, track
  `rgba(255,255,255,0.18)`, a 3×32px tick at each cut (accent for the current one, else
  `rgba(255,255,255,0.5)`), and an accent progress fill.
