...
export const meta: EffectMeta = {
  id: 'metaball-goo', name: 'Metaball Goo', category: 'looks',
  ...
  tags: ['svg', 'morph', 'gradient', 'loop'],
  concepts: ['SVG filter primitives', 'feColorMatrix alpha contrast', 'trig orbits'],
  width: 1920, height: 1080, fps: 30, durationInFrames: 180,
  packages: ['remotion', '@remotion/google-fonts'],
  difficulty: 'intermediate', checkFrame: 88,
  ground: 'dark', audience: ['agency', 'developer'],
};
