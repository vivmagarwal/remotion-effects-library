...
export const meta: EffectMeta = {
  id: 'logo-path-draw', name: 'Logo Path Draw', category: 'motion',
  ...
  tags: ['motion', 'svg', 'logo', 'paths', 'draw-on', 'stroke-dashoffset'],
  ...
  concepts: ['evolvePath', 'getLength', 'per-stroke timing', 'outline then fill'],
};
