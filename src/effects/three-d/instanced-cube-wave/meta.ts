...
export const meta: EffectMeta = {
  id: 'instanced-cube-wave', name: 'Instanced Cube Wave', category: 'three-d',
  ...
  tags: ['3d', 'grid', 'loop', 'ambient'],
  concepts: ['ThreeCanvas', 'InstancedMesh', 'travelling wave'],
  ...
  difficulty: 'advanced', checkFrame: 96,
  ground: 'dark', audience: ['developer', 'saas'], driveMode: 'pure',
};
