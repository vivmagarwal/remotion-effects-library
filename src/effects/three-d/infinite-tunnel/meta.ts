...
export const meta: EffectMeta = {
  id: 'infinite-tunnel', name: 'Infinite Tunnel', category: 'three-d',
  ...
  tags: ['3d', 'camera', 'loop', 'space'],
  concepts: ['ThreeCanvas', 'TubeGeometry', 'camera on a curve', 'seamless loop'],
  ...
  difficulty: 'advanced', checkFrame: 90,
