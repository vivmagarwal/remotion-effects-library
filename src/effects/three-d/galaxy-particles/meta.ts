...
export const meta: EffectMeta = {
  id: 'galaxy-particles', name: 'Galaxy Particles', category: 'three-d',
  ...
  tags: ['3d', 'particles', 'space', 'loop'],
  concepts: ['ThreeCanvas', 'AdditiveBlending', 'random(seed)', 'deterministic layout'],
  ...
  difficulty: 'advanced', checkFrame: 100,
  ground: 'dark', audience: ['agency', 'youtuber'], driveMode: 'pure',
};
