...
export const meta: EffectMeta = {
  id: 'shader-blob', name: 'Shader Blob', category: 'three-d',
  ...
  tags: ['3d', 'shader', 'loop', 'ambient'],
  concepts: ['ThreeCanvas', 'ShaderMaterial', 'vertex displacement'],
  ...
  ground: 'dark', audience: ['agency', 'developer'], driveMode: 'pure',
};
