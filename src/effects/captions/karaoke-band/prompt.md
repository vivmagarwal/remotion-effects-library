Build a Remotion composition called **KaraokeBand** (composition id `karaoke-band`): broadcast-style
...
**Requirements**
- One self-contained `.tsx` file exporting `KaraokeBand` and a `Word` type
