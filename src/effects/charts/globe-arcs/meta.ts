...
export const meta: EffectMeta = {
  id: 'globe-arcs', name: 'Globe Arcs', category: 'charts',
  ...
  tags: ['chart', 'd3', 'geo', 'svg'],
  concepts: ['d3-geo projection', 'deterministic layout', 'paint order'],
  ...
  ground: 'both', audience: ['data', 'agency', 'educator'], driveMode: 'pure',
};
