...
export const meta: EffectMeta = {
  id: 'force-network', name: 'Force Network', category: 'charts',
  ...
  tags: ['chart', 'd3', 'network', 'svg'],
  concepts: ['d3-force', 'pre-ticked simulation', 'deterministic layout'],
  width: 1920, height: 1080, fps: 30, durationInFrames: 180,
  packages: ['remotion', 'd3-force', '@remotion/google-fonts'],
  difficulty: 'advanced', checkFrame: 46, posterFrame: 132,
  ground: 'both', audience: ['data', 'developer'], driveMode: 'baked',
};
