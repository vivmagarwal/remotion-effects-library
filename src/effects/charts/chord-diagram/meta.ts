...
export const meta: EffectMeta = {
  id: 'chord-diagram', name: 'Chord Diagram', category: 'charts',
  ...
  tags: ['chart', 'd3', 'svg', 'network'],
  concepts: ['d3-chord', 'd3-shape', 'polar arcs', 'deterministic layout'],
  width: 1920, height: 1080, fps: 30, durationInFrames: 180,
  packages: ['remotion', 'd3-chord', 'd3-shape', 'd3-array', '@remotion/google-fonts'],
  difficulty: 'advanced', checkFrame: 62,
