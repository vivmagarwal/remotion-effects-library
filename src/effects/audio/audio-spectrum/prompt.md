Build a Remotion composition called **AudioSpectrum**: FFT bars reacting to a real audio file.
...
Put an mp3 in `public/` and reference it with `staticFile('sample-audio.mp3')`.
...
**Requirements**
- One self-contained `.tsx` file exporting `AudioSpectrum`.
