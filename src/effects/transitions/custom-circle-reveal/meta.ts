...
export const meta: EffectMeta = {
  ...
  tags: ['transition', 'clip-path', 'mask', 'css'],
  concepts: ['TransitionPresentation', 'TransitionSeries', 'clip-path reveal'],
  width: 1920, height: 1080, fps: 30, durationInFrames: 138,
  packages: ['remotion', '@remotion/transitions', '@remotion/google-fonts'],
  difficulty: 'intermediate', checkFrame: 76,
  ground: 'dark', audience: ['developer'],
};
