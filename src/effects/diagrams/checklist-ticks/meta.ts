...
export const meta: EffectMeta = {
  id: 'checklist-ticks', name: 'Checklist Ticks', category: 'diagrams',
  ...
  tags: ['checklist', 'list', 'draw-on', 'svg', 'explainer'],
  concepts: ['stroke-dashoffset draw', 'staggered entrance', 'spring overshoot'],
