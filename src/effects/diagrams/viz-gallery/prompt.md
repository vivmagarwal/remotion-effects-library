...
- On a compile error, RENDER the diagnostics instead of throwing — a bordered panel below the eyebrow,
  heading at 700, each message at 34px/500 — and still call `continueRender`, or one uncompilable
  source hangs the render forever. A throw would take all 82 down to report one.
