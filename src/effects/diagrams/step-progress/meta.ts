...
export const meta: EffectMeta = {
  id: 'step-progress', name: 'Step Progress', category: 'diagrams',
  ...
  tags: ['progress', 'diagram', 'explainer', 'stagger'],
  concepts: ['continuous cursor', 'spring overshoot', 'fixed slots without reflow'],
