  ...
  return (
    ...
    >
      ...
      >
        ...
        , and every one is{' '}
        <Circle color="#2f6bff" progress={at(1)}>
          deterministic
        </Circle>
        . Not{' '}
        <StrikeThrough color="#d2483f" progress={at(2)}>
          approximately
        </StrikeThrough>{' '}
        the same each render —{' '}
        <Underline color="#0f9b6c" progress={at(3)}>
          exactly
        </Underline>{' '}
        the same, because the roughness is seeded and the{' '}
        <Box color="#7c3aed" progress={at(4)}>
          progress
        </Box>{' '}
        comes from the frame, not from a{' '}
        <CrossedOff color="#d2483f" progress={at(5)}>
          timer
        </CrossedOff>
        .
      </Interactive.Div>
