...
export const meta: EffectMeta = {
  id: 'browser-window-scroll', name: 'Browser Window Scroll', category: 'ui',
  ...
  tags: ['browser', 'mockup', 'perspective', 'camera'],
  concepts: ['overflow scroll simulation', 'CSS perspective', 'device chrome'],
  width: 1920, height: 1080, fps: 30, durationInFrames: 180,
  packages: ['remotion', '@remotion/google-fonts'],
  difficulty: 'intermediate', checkFrame: 112,
