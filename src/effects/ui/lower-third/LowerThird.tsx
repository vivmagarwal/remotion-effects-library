...
export const LowerThird: React.FC<Props> = ({
  ...
  return (
    <AbsoluteFill
      name="Scene"
      style={{
        backgroundColor: transparent ? 'transparent' : '#1b1f2a',
        backgroundImage: transparent
          ? undefined
          : 'radial-gradient(ellipse at 30% 80%, #2b3550 0%, #12151d 62%)',
        fontFamily,
      }}
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{fontSize: 26, fontWeight: 500, color: '#9aa2b4', letterSpacing: '0.01em'}}>
              {title}
            </div>
          </div>
        </div>
