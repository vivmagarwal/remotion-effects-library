...
export const StepProgress: React.FC<Props> = ({
  ...
  return (
    <AbsoluteFill
      ...
      style={{
        backgroundColor,
        backgroundImage: 'radial-gradient(ellipse at 50% 46%, #171b26 0%, #08090e 70%)',
        fontFamily,
        overflow: 'hidden',
      }}
    >
          ...
          <Interactive.Div key={step.label} name={`Step ${i + 1}`}>
            <div
              style={{
                ...
                height: NODE_R * 2,
                borderRadius: '50%',
                backgroundColor: arrived > 0.5 ? accentColor : '#151a24',
                ...
                fontSize: 34,
                fontWeight: 800,
                color: arrived > 0.5 ? '#08090e' : '#79808f',
            ...
            >
              ...
              <div style={{fontSize: 25, fontWeight: 500, color: '#79808f', marginTop: 8}}>
                {step.detail}
              </div>
            </div>
          </Interactive.Div>
